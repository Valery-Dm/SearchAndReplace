...
public interface Exclusions {
     ...
     * 'xiferp', if it is the case and collection has all prefixes
    ...
    /**
     * Length of the longest prefix stored in collection
     * @return Length of longest prefix
     */
    int maxPrefixSize();
    
    /**
     * Length of the longest suffix stored in collection
